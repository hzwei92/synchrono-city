...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12592 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12592(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12597 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12597(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12606 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12606(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12611 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12611(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12612 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12612(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12613 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12613(reader);
}
});
