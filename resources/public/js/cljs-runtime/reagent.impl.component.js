...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13602 = c;
var G__13602__$1 = (((G__13602 == null))?null:G__13602.prototype);
if((G__13602__$1 == null)){
return null;
} else {
return G__13602__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13603 = c;
var G__13603__$1 = (((G__13603 == null))?null:G__13603.prototype);
if((G__13603__$1 == null)){
return null;
} else {
return G__13603__$1.render;
}
})() == null)))));
});
...
while (G__13692__i < G__13692__a.length) {G__13692__a[G__13692__i] = arguments[G__13692__i + 0]; ++G__13692__i;}
  args = new cljs.core.IndexedSeq(G__13692__a,0,null);
} 
...
var or__5002__auto__ = (function (){var G__13608 = c;
var G__13608__$1 = (((G__13608 == null))?null:G__13608.constructor);
if((G__13608__$1 == null)){
return null;
} else {
return G__13608__$1.displayName;
}
})();
...
var G__13609 = c;
var G__13609__$1 = (((G__13609 == null))?null:G__13609.constructor);
if((G__13609__$1 == null)){
return null;
} else {
return G__13609__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__13631 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13632 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13632);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13631);
}});
...
var c = this;
var G__13670_13699 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__13670_13699 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13670_13699);
}
...
var renders_13700 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_13701 = cljs.core.first(cljs.core.vals(renders_13700));
...
if((cljs.core.count(renders_13700) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13700))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13701)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13701], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__13682 = o;
reagent.impl.component.goog$module$goog$object.set(G__13682,cljs.core.name(k),v);
...
while (G__13706__i < G__13706__a.length) {G__13706__a[G__13706__i] = arguments[G__13706__i + 0]; ++G__13706__i;}
  args = new cljs.core.IndexedSeq(G__13706__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__13683 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13684 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13684);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13683);
}});
...
var vec__13685 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13685,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13685,(1),null);
...
var G__13688 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__13688 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__13688);
}
});
}),[]);
