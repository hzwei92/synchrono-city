...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq17721){
var G__17722 = cljs.core.first(seq17721);
var seq17721__$1 = cljs.core.next(seq17721);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17722,seq17721__$1);
}));
...
var err_17886 = "Invalid Timbre logging level: should be e/o #{:trace :debug :info :warn :error :fatal :report}";
var level__GT_int_17887 = (function (p1__17723_SHARP_){
var G__17724 = p1__17723_SHARP_;
...
if(cljs.core.truth_(level__GT_int_17887(x))){
return true;
} else {
return false;
}
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(err_17886,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type(x)], null));
}
});

taoensso.timbre.valid_level__GT_int = (function taoensso$timbre$valid_level__GT_int(x){
var or__5002__auto__ = level__GT_int_17887(x);
...
var valid_level__GT_int_17889 = taoensso.timbre.valid_level__GT_int;
/**
 * Implementation detail.
 */
taoensso.timbre.level_GT__EQ_ = (function taoensso$timbre$level_GT__EQ_(x,y){
return ((valid_level__GT_int_17889.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_17889.cljs$core$IFn$_invoke$arity$1(x) : valid_level__GT_int_17889.call(null, x)) >= (valid_level__GT_int_17889.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_17889.cljs$core$IFn$_invoke$arity$1(y) : valid_level__GT_int_17889.call(null, y)));
});
var fn_QMARK__17890 = cljs.core.fn_QMARK_;
var compile_17891 = taoensso.encore.fmemoize((function (x){
return taoensso.encore.name_filter(x);
}));
var conform_QMARK__STAR__17892 = taoensso.encore.fmemoize((function (x,ns){
var fexpr__17730 = compile_17891(x);
return (fexpr__17730.cljs$core$IFn$_invoke$arity$1 ? fexpr__17730.cljs$core$IFn$_invoke$arity$1(ns) : fexpr__17730.call(null, ns));
}));
var conform_QMARK__17893 = (function (ns_filter,ns){
if(cljs.core.truth_((fn_QMARK__17890.cljs$core$IFn$_invoke$arity$1 ? fn_QMARK__17890.cljs$core$IFn$_invoke$arity$1(ns_filter) : fn_QMARK__17890.call(null, ns_filter)))){
return (ns_filter.cljs$core$IFn$_invoke$arity$1 ? ns_filter.cljs$core$IFn$_invoke$arity$1(ns) : ns_filter.call(null, ns));
} else {
return conform_QMARK__STAR__17892(ns_filter,ns);
}
});
/**
 * Implementation detail.
...
if(cljs.core.truth_(conform_QMARK__17893(ns_filter,ns))){
return true;
} else {
return false;
}
...
return taoensso.encore.rsome.cljs$core$IFn$_invoke$arity$2((function (p__17733){
var vec__17734 = p__17733;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17734,(0),null);
var min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17734,(1),null);
if(cljs.core.truth_(conform_QMARK__STAR__17892(ns_pattern,ns))){
...
var valid_level_17894 = taoensso.timbre.valid_level;
var ns__GT__QMARK_min_level_17895 = taoensso.timbre.ns__GT__QMARK_min_level;
taoensso.timbre.get_min_level = (function taoensso$timbre$get_min_level(default$,x,ns){
var G__17738 = (function (){var or__5002__auto__ = ((cljs.core.vector_QMARK_(x))?ns__GT__QMARK_min_level_17895(x,ns):x);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return default$;
...
return (valid_level_17894.cljs$core$IFn$_invoke$arity$1 ? valid_level_17894.cljs$core$IFn$_invoke$arity$1(G__17738) : valid_level_17894.call(null, G__17738));
});
var leglist_17896 = (function (x){
if(cljs.core.truth_(x)){
if(cljs.core.truth_((function (){var fexpr__17739 = cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY,cljs.core.PersistentHashSet.EMPTY]);
return (fexpr__17739.cljs$core$IFn$_invoke$arity$1 ? fexpr__17739.cljs$core$IFn$_invoke$arity$1(x) : fexpr__17739.call(null, x));
})())){
return null;
} else {
return x;
...
var ns_whitelist__$1 = leglist_17896(ns_whitelist);
var ns_blacklist__$1 = leglist_17896(ns_blacklist);
...
var level_GT__EQ__17897 = taoensso.timbre.level_GT__EQ_;
var may_log_ns_QMARK__17898 = taoensso.timbre.may_log_ns_QMARK_;
var get_min_level_17899 = taoensso.timbre.get_min_level;
var legacy_ns_filter_17900 = taoensso.timbre.legacy_ns_filter;
/**
 * Implementation detail.
...
var min_level = (function (){var G__17744 = default_min_level;
var G__17745 = (function (){var or__5002__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"min-level","min-level",1634684919));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var G__17746 = _QMARK_ns_str;
return (get_min_level_17899.cljs$core$IFn$_invoke$arity$3 ? get_min_level_17899.cljs$core$IFn$_invoke$arity$3(G__17744,G__17745,G__17746) : get_min_level_17899.call(null, G__17744,G__17745,G__17746));
})();
if(cljs.core.truth_((level_GT__EQ__17897.cljs$core$IFn$_invoke$arity$2 ? level_GT__EQ__17897.cljs$core$IFn$_invoke$arity$2(level,min_level) : level_GT__EQ__17897.call(null, level,min_level)))){
...
var G__17748 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-whitelist","ns-whitelist",-1717299774));
var G__17749 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-blacklist","ns-blacklist",1957763142));
return (legacy_ns_filter_17900.cljs$core$IFn$_invoke$arity$2 ? legacy_ns_filter_17900.cljs$core$IFn$_invoke$arity$2(G__17748,G__17749) : legacy_ns_filter_17900.call(null, G__17748,G__17749));
}
})();
if(cljs.core.truth_(temp__5802__auto__)){
var ns_filter = temp__5802__auto__;
if(cljs.core.truth_((may_log_ns_QMARK__17898.cljs$core$IFn$_invoke$arity$2 ? may_log_ns_QMARK__17898.cljs$core$IFn$_invoke$arity$2(ns_filter,_QMARK_ns_str) : may_log_ns_QMARK__17898.call(null, ns_filter,_QMARK_ns_str)))){
return true;
} else {
return false;
}
...
var min_level_STAR___$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__17760){
var vec__17761 = p__17760;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17761,(0),null);
var _pattern_min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17761,(1),null);
var entry = vec__17761;
...
var min_level_STAR___$2 = (function (){var temp__5802__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(min_level_STAR___$1),(1)))?(function (){var vec__17767 = min_level_STAR___$1;
var vec__17770 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17767,(0),null);
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17770,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17770,(1),null);
...
var map__17780 = timestamp_opts;
var map__17780__$1 = cljs.core.__destructure_map(map__17780);
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17780__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var vec__17793 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17793,(0),null);
if(((auto_error_QMARK_) && (taoensso.encore.error_QMARK_(v0)))){
var _QMARK_err__$1 = v0;
var _QMARK_meta = null;
var vargs__$1 = taoensso.encore.vrest(vargs);
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__17798 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17798,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__17804 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17804,(0),null);
return v0__$1;
})():null);
var vargs__$2 = ((fmt_msg_QMARK_)?taoensso.encore.vrest(vargs__$1):vargs__$1);
...
}catch (e17811){var t = e17811;
var map__17812 = data;
var map__17812__$1 = cljs.core.__destructure_map(map__17812);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17812__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17812__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17812__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17812__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
var _QMARK_column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17812__$1,new cljs.core.Keyword(null,"?column","?column",1004649085));
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$3(error_msg,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),f,new cljs.core.Keyword(null,"level","level",1290497552),level,new cljs.core.Keyword(null,"data","data",-232669377),data,new cljs.core.Keyword(null,"loc","loc",-584284901),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"ns","ns",441598760),_QMARK_ns_str,new cljs.core.Keyword(null,"file","file",-1269645878),_QMARK_file,new cljs.core.Keyword(null,"line","line",212345235),_QMARK_line], null)], null),t);
}});
});
...
if(taoensso.timbre.may_log_QMARK_.cljs$core$IFn$_invoke$arity$4(new cljs.core.Keyword(null,"trace","trace",-1082747415),level,_QMARK_ns_str,config)){
var instant_17904 = (new Date());
var context_17905 = taoensso.timbre._STAR_context_STAR_;
var vargs_17906 = cljs.core.deref(vargs_);
var vec__17827_17907 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_17906);
var _QMARK_err_17908__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17827_17907,(0),null);
var _QMARK_meta_17909 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17827_17907,(1),null);
var _QMARK_msg_fmt_17910 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17827_17907,(2),null);
var vargs_17911__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17827_17907,(3),null);
var data_17912 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5002__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"spying?","spying?",1753444487),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891),new cljs.core.Keyword(null,"?column","?column",1004649085)],[instant_17904,spying_QMARK_,config,vargs_17911__$1,_QMARK_file,cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null),level),_QMARK_ns_str,level,msg_type,_QMARK_err_17908__$1,context_17905,_QMARK_line,_QMARK_meta_17909,_QMARK_msg_fmt_17910,_QMARK_column]));
var _QMARK_data_17913 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_17912,cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"middleware","middleware",1462115504)));
var temp__5804__auto___17914 = _QMARK_data_17913;
if(cljs.core.truth_(temp__5804__auto___17914)){
var data_17915__$1 = temp__5804__auto___17914;
var map__17836_17916 = data_17915__$1;
var map__17836_17917__$1 = cljs.core.__destructure_map(map__17836_17916);
var vargs_17918__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17836_17917__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_17919__$2 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_17915__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
return taoensso.timbre.protected_fn("Timbre error when calling (msg-fn <data>)",taoensso.timbre.default_output_msg_fn)(data_17915__$1);
...
return cljs.core.hash((function (){var b2__13159__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_17909,new cljs.core.Keyword(null,"id","id",-1388402092));
if(cljs.core.truth_(b2__13159__auto__)){
var id = b2__13159__auto__;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,callsite_id,level], null);
} else {
var b2__13159__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_17909,new cljs.core.Keyword(null,"id!","id!",218090956));
if(cljs.core.truth_(b2__13159__auto____$1)){
var id = b2__13159__auto____$1;
return id;
} else {
var b2__13159__auto____$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_17909,new cljs.core.Keyword(null,"hash","hash",-13781596));
if(cljs.core.truth_(b2__13159__auto____$2)){
var h = b2__13159__auto____$2;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,callsite_id,_QMARK_msg_fmt_17910,level], null);
} else {
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [vargs_17918__$2,callsite_id,_QMARK_msg_fmt_17910,level], null);
}
}
}
})());
}),null))], 0));
var get_timestamp_delay_17920 = (function (){var get_shared_delay = taoensso.encore.fmemoize((function (opts){
return (new cljs.core.Delay((function (){
return taoensso.timbre.get_timestamp(opts,cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_17919__$2,new cljs.core.Keyword(null,"instant","instant",655498374)));
}),null));
}));
...
var get_output_fn_17921 = (function (){var base_fn = taoensso.encore.fmemoize(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
var base_output_opts_17922 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return cljs.core.not((function (){var G__17843 = cljs.core.force(cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_17919__$2,new cljs.core.Keyword(null,"hash_","hash_",-827203612)));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__17843) : rl_fn.call(null, G__17843));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__17844 = appender;
var map__17844__$1 = cljs.core.__destructure_map(map__17844);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17844__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17844__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
var timestamp_ = get_timestamp_delay_17920(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807)));
var output_fn = get_output_fn_17921(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539)));
...
return base_output_opts_17922;
}
})();
var output_ = (new cljs.core.Delay((function (){
var G__17847 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(data_17919__$2,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts], 0));
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(G__17847) : output_fn.call(null, G__17847));
}),null));
var data__$3 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_17919__$2,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_], null));
...
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17857__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
 ...
 */
taoensso.timbre.default_output_msg_fn = (function taoensso$timbre$default_output_msg_fn(p__17866){
var map__17867 = p__17866;
var map__17867__$1 = cljs.core.__destructure_map(map__17867);
var data = map__17867__$1;
var msg_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17867__$1,new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822));
var _QMARK_msg_fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17867__$1,new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891));
var vargs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17867__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17867__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var map__17868 = output_opts;
var map__17868__$1 = cljs.core.__destructure_map(map__17868);
var arg__GT_str_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17868__$1,new cljs.core.Keyword(null,"arg->str-fn","arg->str-fn",2064845310),taoensso.timbre.default_arg__GT_str_fn);
var G__17869 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__17869)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__17869)){
return taoensso.timbre.str_join.cljs$core$IFn$_invoke$arity$2(arg__GT_str_fn,vargs);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__17869)){
 ...
 */
taoensso.timbre.default_output_error_fn = (function taoensso$timbre$default_output_error_fn(p__17870){
var map__17871 = p__17870;
var map__17871__$1 = cljs.core.__destructure_map(map__17871);
var data = map__17871__$1;
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17871__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17871__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var err = (((!((_QMARK_err == null))))?_QMARK_err:taoensso.truss.impl._invar_violation_BANG_(true,new cljs.core.Symbol(null,"taoensso.timbre","taoensso.timbre",407940729,null),944,13,"jar:file:/Users/peterwei/.m2/repository/com/taoensso/timbre/6.5.0/timbre-6.5.0.jar!/taoensso/timbre.cljc",new cljs.core.Keyword("taoensso.truss.impl","some?","taoensso.truss.impl/some?",1536228403),new cljs.core.Symbol("cljs.core","some?","cljs.core/some?",-440439360,null),new cljs.core.Symbol(null,"?err","?err",-2104782470,null),_QMARK_err,null,null));
var nl = "\n";
...
return [nl,nl,"Caused by:",nl,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__17875 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data,new cljs.core.Keyword(null,"?err","?err",549653299),c);
return (taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1(G__17875) : taoensso.timbre.default_output_error_fn.call(null, G__17875));
})())].join('');
} else {
return null;
}
 ...
 */
taoensso.timbre.default_config = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"min-level","min-level",1634684919),new cljs.core.Keyword(null,"debug","debug",-1608172596),new cljs.core.Keyword(null,"ns-filter","ns-filter",108598448),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["*",null], null), null),new cljs.core.Keyword(null,"middleware","middleware",1462115504),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807),taoensso.timbre.default_timestamp_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn,new cljs.core.Keyword(null,"appenders","appenders",1245583998),(((typeof window !== 'undefined'))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"console","console",1228072057),(function (){var G__17878 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1(G__17878) : taoensso.timbre.console_appender.call(null, G__17878));
})()], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"println","println",1920840330),(function (){var G__17879 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1(G__17879) : taoensso.timbre.println_appender.call(null, G__17879));
})()], null))], null);
...
var args__5732__auto__ = [];
var len__5726__auto___17952 = arguments.length;
var i__5727__auto___17953 = (0);
while(true){
if((i__5727__auto___17953 < len__5726__auto___17952)){
args__5732__auto__.push((arguments[i__5727__auto___17953]));

var G__17954 = (i__5727__auto___17953 + (1));
i__5727__auto___17953 = G__17954;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq17880){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq17880));
}));
