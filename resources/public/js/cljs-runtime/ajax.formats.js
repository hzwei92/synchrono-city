...
var G__12633 = request;
var G__12634 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12633,G__12634) : ajax.formats.get_format.call(null, G__12633,G__12634));
} else {
...
return cljs.core.some((function (p1__12639_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12639_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12645){
var map__12646 = p__12645;
var map__12646__$1 = cljs.core.__destructure_map(map__12646);
var request = map__12646__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12646__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12654 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12654.cljs$core$IFn$_invoke$arity$1 ? fexpr__12654.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12654.call(null, response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12656){
var map__12658 = p__12656;
var map__12658__$1 = cljs.core.__destructure_map(map__12658);
var request = map__12658__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12658__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12655_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12655_SHARP_);
