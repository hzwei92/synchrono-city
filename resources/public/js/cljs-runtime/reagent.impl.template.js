...
var G__13712 = o;
reagent.impl.template.goog$module$goog$object.set(G__13712,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__13730__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__13730 = function (var_args){
var args = null;
...
while (G__13731__i < G__13731__a.length) {G__13731__a[G__13731__i] = arguments[G__13731__i + 0]; ++G__13731__i;}
  args = new cljs.core.IndexedSeq(G__13731__a,0,null);
} 
return G__13730__delegate.call(this,args);};
G__13730.cljs$lang$maxFixedArity = 0;
G__13730.cljs$lang$applyTo = (function (arglist__13732){
var args = cljs.core.seq(arglist__13732);
return G__13730__delegate(args);
});
...
var G__13713 = o;
reagent.impl.template.goog$module$goog$object.set(G__13713,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__13734__i < G__13734__a.length) {G__13734__a[G__13734__i] = arguments[G__13734__i + 0]; ++G__13734__i;}
  args = new cljs.core.IndexedSeq(G__13734__a,0,null);
} 
...
var G__13714 = props;
var G__13714__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13714,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__13714);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13714__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__13715 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13715,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__13715;
}
})(),id_class);
...
var G__13716 = (cljs.core.count(argv) - first_child);
switch (G__13716) {
case (0):
...
var vec__13717 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13717,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13717,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13717,(2),null);
...
var temp__5808__auto___13737 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___13737 == null)){
} else {
var key_13738 = temp__5808__auto___13737;
(jsprops.key = key_13738);
}
...
var temp__5808__auto___13739 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___13739 == null)){
} else {
var key_13740 = temp__5808__auto___13739;
(jsprops.key = key_13740);
}
...
var temp__5808__auto___13741 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___13741 == null)){
} else {
var key_13742 = temp__5808__auto___13741;
(jsprops.key = key_13742);
}
...
var temp__5808__auto___13743 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___13743 == null)){
} else {
var key_13744 = temp__5808__auto___13743;
(jsprops.key = key_13744);
}
...
var temp__5808__auto___13745 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___13745 == null)){
} else {
var key_13746 = temp__5808__auto___13745;
(jsprops.key = key_13746);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13720_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__13720_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__13721 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13721,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13721,(1),null);
...
break;
default:
var G__13750 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__13751 = compiler;
v = G__13750;
compiler = G__13751;
continue;
...
var G__13725 = tag;
var G__13725__$1 = (((G__13725 instanceof cljs.core.Keyword))?G__13725.fqn:null);
switch (G__13725__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template13727 = (function (opts,id,fn_to_element,parse_fn,meta13728){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template13727.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13729,meta13728__$1){
var self__ = this;
var _13729__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template13727(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta13728__$1));
}));

(reagent.impl.template.t_reagent$impl$template13727.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13729){
var self__ = this;
var _13729__$1 = this;
return self__.meta13728;
}));

(reagent.impl.template.t_reagent$impl$template13727.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template13727.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template13727.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template13727.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template13727.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template13727.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta13728","meta13728",656507803,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template13727.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template13727.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template13727");

(reagent.impl.template.t_reagent$impl$template13727.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template13727");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template13727.
 */
reagent.impl.template.__GT_t_reagent$impl$template13727 = (function reagent$impl$template$__GT_t_reagent$impl$template13727(opts,id,fn_to_element,parse_fn,meta13728){
return (new reagent.impl.template.t_reagent$impl$template13727(opts,id,fn_to_element,parse_fn,meta13728));
});
...
return (new reagent.impl.template.t_reagent$impl$template13727(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
