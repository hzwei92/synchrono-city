...
var len__5726__auto___14550 = arguments.length;
var i__5727__auto___14551 = (0);
while(true){
if((i__5727__auto___14551 < len__5726__auto___14550)){
args__5732__auto__.push((arguments[i__5727__auto___14551]));

var G__14552 = (i__5727__auto___14551 + (1));
i__5727__auto___14551 = G__14552;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__14487){
var map__14488 = p__14487;
var map__14488__$1 = cljs.core.__destructure_map(map__14488);
var m = map__14488__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14488__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14488__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14488__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14488__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___14553 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___14553){
var unknown_keys_14554 = temp__5802__auto___14553;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_14554], 0));
} else {
}
} else {
}

var G__14489 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5002__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14489,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__14489;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq14484){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14484));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___14556 = arguments.length;
var i__5727__auto___14557 = (0);
while(true){
if((i__5727__auto___14557 < len__5726__auto___14556)){
args__5732__auto__.push((arguments[i__5727__auto___14557]));

var G__14558 = (i__5727__auto___14557 + (1));
i__5727__auto___14557 = G__14558;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq14494){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14495,G__14496,G__14497,seq14494__$3);
}));
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq14504){
...
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14505,G__14506,G__14507,seq14504__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__14510,interceptor,direction){
var map__14511 = p__14510;
var map__14511__$1 = cljs.core.__destructure_map(map__14511);
var context = map__14511__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14511__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq14525){
var G__14526 = cljs.core.first(seq14525);
var seq14525__$1 = cljs.core.next(seq14525);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14526,seq14525__$1);
}));
...
var map__14527 = cljs.core.ex_data(re_frame_error);
var map__14527__$1 = cljs.core.__destructure_map(map__14527);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14527__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14527__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14527__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
var event_handler_QMARK_ = (function (){var fexpr__14532 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097),null,new cljs.core.Keyword(null,"db-handler","db-handler",579530098),null,new cljs.core.Keyword(null,"ctx-handler","ctx-handler",-1777672230),null], null), null);
return (fexpr__14532.cljs$core$IFn$_invoke$arity$1 ? fexpr__14532.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__14532.call(null, interceptor));
})();
...
}catch (e14540){var e = e14540;
var G__14541 = cljs.core.ex_cause(e);
var G__14542 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__14541,G__14542) : error_handler.call(null, G__14541,G__14542));
}}
});
