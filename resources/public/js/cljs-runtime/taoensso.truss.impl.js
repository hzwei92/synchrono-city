...
var ensure_set_12646 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(m)),(ensure_set_12646.cljs$core$IFn$_invoke$arity$1 ? ensure_set_12646.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_12646.call(null, ks)));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_12646.cljs$core$IFn$_invoke$arity$1 ? ensure_set_12646.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_12646.call(null, ks)));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_12646.cljs$core$IFn$_invoke$arity$1 ? ensure_set_12646.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_12646.call(null, ks)));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_((function (p1__12617_SHARP_){
return (!((cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__12617_SHARP_) == null)));
}),ks);
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__12620_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("clojure.core",p1__12620_SHARP_);
}),names)),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__12621_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("cljs.core",p1__12621_SHARP_);
}),names));
})();
taoensso.truss.impl.safe_pred = (function taoensso$truss$impl$safe_pred(pred){
return (function (x){
try{return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(x) : pred.call(null, x));
}catch (e12626){if((e12626 instanceof Error)){
var _ = e12626;
return null;
} else {
throw e12626;
...
var G__12637 = (new cljs.core.Delay((function (){
...
}catch (e12641){if((e12641 instanceof Error)){
var e = e12641;
...
return (error_fn.cljs$core$IFn$_invoke$arity$1 ? error_fn.cljs$core$IFn$_invoke$arity$1(G__12637) : error_fn.call(null, G__12637));
} else {
return null;
}
});
