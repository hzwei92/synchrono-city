shadow$provide.module$node_modules$nostr_tools$node_modules$$noble$hashes$utils = function(global, require, module, exports) {
  ...
  function toBytes(data) {
    ...
    if (!(data instanceof Uint8Array)) {
      throw Error(`expected Uint8Array, got ${typeof data}`);
    }
    return data;
  }
  Object.defineProperty(exports, "__esModule", {value:!0});
  exports.randomBytes = exports.wrapXOFConstructorWithOpts = exports.wrapConstructorWithOpts = exports.wrapConstructor = exports.checkOpts = exports.Hash = exports.concatBytes = exports.toBytes = exports.utf8ToBytes = exports.asyncLoop = exports.nextTick = exports.hexToBytes = exports.bytesToHex = exports.isLE = exports.rotr = exports.createView = exports.u32 = exports.u8 = void 0;
  const crypto_1 = require("module$node_modules$nostr_tools$node_modules$$noble$hashes$crypto");
  ...
  exports.hexToBytes = function(hex) {
    ...
    var len = hex.length;
    if (len % 2) {
      throw Error("padded hex string expected, got unpadded hex of length " + len);
    }
    len = new Uint8Array(len / 2);
    for (let i = 0; i < len.length; i++) {
      var j = 2 * i;
      j = hex.slice(j, j + 2);
      j = Number.parseInt(j, 16);
      if (Number.isNaN(j) || 0 > j) {
  ...
  exports.checkOpts = function(defaults, opts) {
    var JSCompiler_temp;
    if (JSCompiler_temp = void 0 !== opts) {
      (JSCompiler_temp = "object" !== typeof opts) || (JSCompiler_temp = !("[object Object]" === Object.prototype.toString.call(opts) && opts.constructor === Object));
    }
    if (JSCompiler_temp) {
...
//# sourceMappingURL=module$node_modules$nostr_tools$node_modules$$noble$hashes$utils.js.map
